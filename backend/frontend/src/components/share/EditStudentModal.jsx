...
const EditStudentModal = ({ isModalOpen, handleCloseModal, handleEditSubmit, handleChange, editStudent, notification, notificationType, notificationError }) => {
    return (
        <div
        ...
        >
            <div className="bg-white p-8 rounded shadow-lg w-3/5 relative">
                <h2 className="text-2xl font-bold mb-4">Chỉnh Sửa Học Viên</h2>
                ...
                <form onSubmit={handleEditSubmit} className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        <label htmlFor="extraClasses" className="block text-sm font-medium text-gray-700">
                            Lớp học thêm
                        </label>
                        <input
                            type="text"
                            ...
                            className="mt-1 block w-full border border-gray-300 rounded px-3 py-2"
                            name="extraClasses"
                            value={editStudent.extraClasses.join(', ')} // Join for display
                            onChange={(e) => {
                                // Split and trim on change
